          ...
          <div className="bg-neutral-100 rounded-3xl shadow-2xl border border-neutral-300 p-8 sm:p-12">
            ...
            <div className="mb-10">
              ...
              <div className="flex flex-wrap gap-2 mb-4">
                {skills.map((skill, i) => (
                  <span key={skill} className="px-4 py-2 text-white rounded-full text-sm shadow-md flex items-center gap-2"
            ...
            <button type="button" onClick={handleSubmit}
              ...
              {saving ? (
                ...
                <><i className="fa-solid fa-check mr-2" />Complete Profile</>
              )}
            </button>
